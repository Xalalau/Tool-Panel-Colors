...
CreateClientConVar("tpc_addon_bright_r", "")
CreateClientConVar("tpc_addon_bright_g", "")
CreateClientConVar("tpc_addon_bright_b", "")
CreateClientConVar("tpc_addon_bright_a", "")
CreateClientConVar("tpc_addon_dark_r", "")
CreateClientConVar("tpc_addon_dark_g", "")
CreateClientConVar("tpc_addon_dark_b", "")
CreateClientConVar("tpc_addon_dark_a", "")
CreateClientConVar("tpc_addon_font_r", "")
CreateClientConVar("tpc_addon_font_g", "")
CreateClientConVar("tpc_addon_font_b", "")
CreateClientConVar("tpc_addon_font_a", "")
    ...
    for _, col in ipairs(toolPanelList.pnlCanvas:GetChildren()) do
        for __, pnl in ipairs(col:GetChildren()) do
            if pnl.ClassName ~= "DCategoryHeader" then
                local toolType = self.highlights[pnl.Name] and "Highlight" or self.defaultTools[pnl.Name] and "GMod" or "Addon"
